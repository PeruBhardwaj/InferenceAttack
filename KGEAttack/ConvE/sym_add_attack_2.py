...
#     - Select entity substitution that are ranked just worse than target triple on both sides 
...
if __name__ == '__main__':
    ...
    save_path = 'data/sym_add_2_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, args.target_split, args.budget, args.rand_run)
    ...
    with open(os.path.join(save_path, 'stats.txt'), 'w') as f:
        ...
        f.write('This attack version is using ranks just worse than target triples \n')
        f.write('---------------------------------------------------------------------- \n')
