...
if __name__ == '__main__':
    ...
    log_path = 'logs/attack_logs/sym_add_3/{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, args.target_split, args.budget, args.rand_run)
    ...
    save_path = 'data/sym_add_3_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, args.target_split, args.budget, args.rand_run)
    ...
    with open(os.path.join(save_path, 'stats.txt'), 'w') as f:
        ...
        f.write('This attack version uses cosine distance between target entity and decoy entity \n')
        f.write('---------------------------------------------------------------------- \n')
